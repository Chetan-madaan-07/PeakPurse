...
const StatementViewer = dynamic(() => import('../components/StatementViewer'), {
  ssr: false,
  loading: () => (
    <div className="bg-white p-6 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 h-full min-h-[400px] flex items-center justify-center">
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans selection:bg-indigo-200">
          ...
          <div className="space-y-12 animate-fade-in-down transition-all duration-700">
            ...
            <div className="text-center mt-12 pb-8">
              <button 
                ...
                className="px-8 py-3 bg-white border border-gray-200 shadow-sm text-gray-600 font-bold rounded-full hover:bg-gray-50 hover:shadow-md hover:text-indigo-600 transition-all duration-300 tracking-wide uppercase text-sm"
              >
